...
### 2. 파일 권한 (r/w/x) 및 숫자 표기법 (755, 644)
...
* *ex)*: Git이 내 컴퓨터 안의 '작업 노트'라면, GitHub는 노트를 공유하는 '온라인 도서관'입니다.
